...

{
  ...
  networking.hostName = "inspiron-5368"; # Define your hostname.
  ...
  # Set your time zone.
  time.timeZone = "America/Yellowknife";
  ...
  # Automatic upgrades and reboot when needed
